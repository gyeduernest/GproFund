...
export default function Projects() {
  return (
    <div className="lg:pl-72 md:py-48 py-10 lg:h-full lg:py-32 z-0">
      <div className="flex lg:gap-10 mb-10 justify-center md:gap-10 gap-1">
        <Badge>Education</Badge>
        <Badge color="green">Health</Badge>
        <Badge color="indigo">Housing</Badge>
        <Badge color="yellow">Sports</Badge>
      </div>
